...
import net.lzzy.practicesonline.fragments.view.BarChartView;
...
import static net.lzzy.practicesonline.models.View.WrongType.EXTRA_OPTIONS;
import static net.lzzy.practicesonline.models.View.WrongType.MISS_OPTIONS;
import static net.lzzy.practicesonline.models.View.WrongType.RIGHT_OPTIONS;
import static net.lzzy.practicesonline.models.View.WrongType.WRONG_OPTIONS;
...
public class ChartFragment extends BaseFragment {
    ...
    private StateActivityInterface cutClickListener;
    ...
    private void initCharts() {
        ...
        lChart=find(R.id.fragment_chart_lin);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ChartFragment.StateActivityInterface){
            cutClickListener= (ChartFragment.StateActivityInterface) context;
        }else {
